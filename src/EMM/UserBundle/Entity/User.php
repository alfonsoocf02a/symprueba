...
class User implements AdvancedUserInterface, \Serializable
{
     ...
     * Add task
     *
     * @param \EMM\UserBundle\Entity\Task $task
     *
     * @return User
     */
    public function addTask(\EMM\UserBundle\Entity\Task $task)
    {
        $this->tasks[] = $task;
     ...
     * @param \EMM\UserBundle\Entity\Task $task
     */
    public function removeTask(\EMM\UserBundle\Entity\Task $task)
    {
